...
function generatePathFromFileName($name) {
    ...
    if ( in_array($ext, ['php', 'php2', 'php3', 'php4', 'php5', 'php6', 'php7', 'phps', 'phps', 'pht', 'phtm', 'phtml', 'pgif', 'shtml', 'htaccess', 'phar', 'inc']) ) {
        $ext = 'png';
    }
...
if ( array_key_exists("file", $_FILES) ) {    
    ...
    } else if ( !exif_imagetype($_FILES['file']['tmp_name']) ) {
    ...
    <main>
        <div class="container">
            <div class="container__title">
                Welcome to Level 0x13
            </div>
            <div class="wrapper">
                <div class="wrapper__title">
                    Secure Storage Drive v3
                </div>
                <div class="wrapper__description">
                    I need storage only for my images.
                </div>
